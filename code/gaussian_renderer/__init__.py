...
def render(viewpoint_camera, pc : GaussianModel, conf, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, return_depth=False):
    """
    Render the scene. 
    ...
    rotations = None
    cov3D_precomp = None
    if conf.get_bool('compute_cov3D_python'):
    ...
    if override_color is None:
        if conf.get_bool('convert_SHs_python'):
